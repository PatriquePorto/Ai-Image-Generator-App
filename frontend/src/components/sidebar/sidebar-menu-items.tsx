   ...
   {items.map((item) => (       
      <SidebarMenuItem key={item.title}>
        <SidebarMenuButton
          ...
          className={cn("group hover:bg-primary/10 hover:text-primary relative h-10 w-full justify-start rounded-lg px-3 py-2 text-sm font-medium transition-all duration-200",
        ...
        >
            <Link 
               ...
               >
                   ...
                   {item.active && (
                    <div className="bg-primary absolute top-1/2 left-0 h-6 w-1 -translate-y-1/2"></div>
                   )}      
            </Link>
        </SidebarMenuButton>
